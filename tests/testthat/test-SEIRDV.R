...
test_that("SEIRV model runs correctly", {
  my_model <- SEIRDV()
  initial_conditions(my_model) <- list(S0=0.9, E0=0, I0=0.1, R0=0, V0=0)
  ...
  test <- rowSums(out_df_SEIRV[, c(2:5)]) + out_df_CD$Deaths

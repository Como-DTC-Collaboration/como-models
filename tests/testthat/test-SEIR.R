test_that("SEIR model is set up correctly", {
  my_model <- new("SEIR_model", name = "my_model", parameter_names = list("S0", "E0", "I0", "R0", "beta", "kappa", "gamma"))
...
test_that("Errors are raised properly", {
  ...
  expect_error(set_parameters(my_model, 0.9, 0, 0.1, 0, list(0.1,0.1), 0.2, 0.3),

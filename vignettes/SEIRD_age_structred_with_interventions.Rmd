...
model <- SEIRDAge_interventions(n_age_categories = n_ages,
                                contact_matrix = list(c_combined_wider,c_combined_wider,c_combined_wider,c_combined_wider),
                                age_ranges = as.list(age_names))

transmission_parameters(model) <- list(isolated_frac = 0.4,
...
intervention_parameters(model) <- list(starts=c(10, 25, 40),
                                      stops=c(15, 30, 50))

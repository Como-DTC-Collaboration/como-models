...
single infectious individual in a population where everyone is susceptible. If $R_0>1$, the epidemic grows exponentially; if $R_0<1$, transmission dies out over time. In an SEIRD model, the reproductive number is given by:

...
Here, we follow the first approach to parameterising the SEIRD model, and show later how a sensitivity analysis can be performed. We provide an introduction to the second approach in [insert vignette for optimisation].

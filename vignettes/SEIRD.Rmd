...
We can access the overall system of equations in a markdown-renderable form through the `ode_system_equations` function. This requires us first to create an `SEIRD` model object.
...
# view equations
ode_system_equation(my_model)

f_tets <- function() {
  eq <- paste0("\\begin{equation}\n",
         "x + y\n",
  "\\end{equation}")

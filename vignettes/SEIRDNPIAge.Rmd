...
In addition to these five main ODEs, the model also keeps track of the cumulative number of cases ($C$) (here defined as those individuals infected with the virus) over time:

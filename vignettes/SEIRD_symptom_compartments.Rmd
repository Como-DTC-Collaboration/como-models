...
* $\eta_i$ - the probability of exposed individuals that, after the incubation period, moving into each of the different infected groups $i$. $\sum_i\eta_i=1$, $i\in\{a, m, s\}.$

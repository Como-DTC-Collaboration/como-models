...
```{r, fig.width = 15, fig.align = "center", fig.show="hold"}
par(mfrow=c(1,2))
...
grid.arrange(model.plot.states, model.plot.changes, nrow = 1)
```
...
grid.arrange(model1.plot.states, model1.plot.changes, nrow=1)
```
...
grid.arrange(model2.plot.states, model2.plot.changes, nrow=1)
```

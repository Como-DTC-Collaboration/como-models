...
to initial conditions. First, we set all initial infections to 0.3% of the total population and place this 0.1% uniformly across age groups between 15 and 30. Second, we place all infections (also 0.3% of the total population) uniformly across age groups 55-70. 
```{r}
...
<<<<<<< HEAD
res <- run(model_5570, time=seq(0, 50, by = 0.1))
=======
res <- run(model_5070, time=seq(0, 50, by = 0.1))$states
>>>>>>> 740808d06f7b4d34c425b023a9bba2e64dc0783b
res %>%
  filter(compartment=="I") %>% 
  ggplot(aes(x=time, y=value, colour=age_range)) +

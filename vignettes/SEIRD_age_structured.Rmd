...
We probably want to use more realistic demographics here for each age population: can we get these from comoDTC?
```{r}
n_ages <- 16
...
initial_conditions(model) <- list(S0=rep(0.05, n_ages),
                                  E0=rep(0, n_ages),
                                  I0=rep(0.0125, n_ages),
                                  R0=rep(0, n_ages))
```

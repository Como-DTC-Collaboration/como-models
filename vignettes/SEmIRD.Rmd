...
```{r, fig.height = 5, fig.width = 7}
# helper function for running models with parameterisation on kappa and the number of compartments
run_seird_semird <- function(kappa, n){
...
p1 <- run_seird_semird(kappa[1], n)
p2 <- run_seird_semird(kappa[2], n)
p3 <- run_seird_semird(kappa[3], n)

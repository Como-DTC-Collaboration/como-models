...
how populations of susceptible, exposed, infected and recovered
individuals evolve over time. Each population is described by a simple
ordinary differential equation. The S4 object class "SEIR_Model" let's the user
...
Infected individuals ($I$) are infectious, and recovered individuals ($R$) are no longer
...
infected, and the probability of that an infected individual infects a
...
Exposed individuals become infected at rate $\kappa$. $1/ \kappa$ is
the incubation time of the virus, i.e. how many days after exposure the individual
becomes infected, and infectious to others. Finally, an infection lasts $1/ \gamma$
...
the biology, because as long as their are (soon to be) infectious individuals
...
```
You can assign any name you would like for the model to the name parameter.
...
population is susceptible, 10% is infected and infectious and noone is

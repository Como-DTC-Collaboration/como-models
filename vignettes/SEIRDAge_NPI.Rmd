...
**an age-structured model including NPI strategies (SEIRDAge_NPI)** and demonstrate the effect of a number of different NPI strategies to examine the effects of interventions. Since a number of the aforementioned NPIs have varying effects on different age groups, we chose to account for them by extending the [SEIRDAge model](https://github.com/Como-DTC-Collaboration/como-models/blob/main/vignettes/SEIRD_age_structured.Rmd). 
...
where $i$ represents a particular age class, and $t$ represents a time point. 

Any NPI strategy can be appied to multiple, 

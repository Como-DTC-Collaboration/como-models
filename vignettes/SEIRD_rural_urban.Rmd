...
```
We also load in all demographic data from the excel sheets, and load in a list showing the which three-letter code for each country.
```{r}
#import all demographic data
# data on percentage of the population that is rural
#country_pop_rural <- read_excel("../Country_ruralpop_data.xlsx", sheet = "Data", skip = 3)
country_pop_rural <- read_excel(system.file("extdata", "Country_ruralpop_data.xlsx", package = "como-models", mustWork = TRUE), sheet = "Data", skip = 3)
# age demographic breakdown into 5 year age categories
#country_pop_byage <- read_excel("../Populationper5yearagegroup.xlsx", sheet = "ESTIMATES", skip = 16)
country_pop_byage <- read_excel(system.file("extdata", "Populationper5yearagegroup.xlsx", package = "como-models", mustWork = TRUE), sheet = "ESTIMATES", skip = 16)
# conversion table from 3 letter country codes to full names
#code_to_country <-  read_excel("../Country_totalpop_data.xlsx", sheet = "Metadata - Countries")
code_to_country <- read_excel(system.file("extdata", "Country_totalpop_data.xlsx", package = "como-models", mustWork = TRUE), sheet = "Metadata - Countries")
```

...
Below we can see a plot of the a claassical level of interventions that occur at each time step.
...
peak. Also, the earlier the second wave occurs, the higher its applitude will be.

...
for(i in 1:n_ages){
  interven[[i]]$starts <- c(35-i, 80-i, 135-i)
  interven[[i]]$stops <-  c(60, 95, 180)
  interven[[i]]$coverages <- c(1,1,1)
}
...
var_interven <- function(start){
  ...
  for(i in 1:n_ages){
    interven[[i]]$starts <- c(35-i, 80-i, 135-i)+start
    interven[[i]]$stops <-  c(60, 95, 180)+start
    interven[[i]]$coverages <- c(1,1,1)
  }

...
$\delta_V$, $\delta_R$ and $\delta_{VR}$. For realistic results, the mortality
parameter $\mu$ is age-dependent as according to [Verity (2020)](https://www.medrxiv.org/content/early/2020/03/13/2020.03.09.20033357):
```{r}

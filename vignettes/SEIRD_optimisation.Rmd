...
LogLikelihoodFn <- function(parameters, model=SEIRD(), inc_numbers=0, death_numbers=0,
  ...
  #print(length(logIncidence))
  #print(length(inc_numbers))
...
#beta_range <- seq(0.7, 0.71, by = 0.02)
#kappa_range <- seq(0.6, 0.61, by = 0.02)
#gamma_range <- seq(0.3, 0.31, by = 0.02)
#mu_range <- seq(0.02, 0.0201, by = 0.005)
